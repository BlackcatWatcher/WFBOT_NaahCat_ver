    ...
    public static class Messenger
    {
        ...
        public static void Broadcast(string content)
        {
            Task.Factory.StartNew(() =>
            {
                ...
                {
                    if (count > 20 && content.StartsWith("兔子小姐搞找到新东西啦，更新更新~")) return;
        ...
        public static void SendBotStatus(GroupNumber group)
        {
            ...
            {
                sb.AppendLine("兔子小姐状态: 一切正常");
            }
            else
            {
                sb.AppendLine("兔子小姐状态: 不正常");
            }
        ...
        {
            SendGroup(@group, @"这是基于WFBot的机器人噢!
作者: TheRealKamisama 修订者：千央黑猫");
    ...
    查询(也可用wm指令) [物品名称] | 查询 WarframeMarket, 查询未开紫卡请输入: 手枪未开紫卡
    紫卡(也可用rm指令) [武器名称] | 紫卡市场 数据来自 RivenMarket 紫卡市场
    （支持指令“带回复”、“无在线优先”、“零洗/低洗”、“正面-属性1+属性2+属性3-”、“负面-属性4-”、“页码-数字-”、“平台-PC/PS4/NS1/NSW-”、“小于-1天/1周/1月-”来筛选紫卡）
    国内紫卡(也可用wfa指令) [武器名称] | 紫卡市场 数据来自 WFA 紫卡市场
    地球赏金 | 地球平原的全部/单一赏金任务
    金星赏金 | 金星平原的全部/单一赏金任务
    裂隙 | 查询全部裂隙
