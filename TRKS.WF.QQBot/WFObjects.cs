...
namespace TRKS.WF.QQBot
{
    ...
    public class RivenInfoRm
    {
        public string data_Weapon { get; set; }
        public string data_Name { get; set; }
        public int data_Price { get; set; }
        public int data_Rank { get; set; }
        public int data_Mr { get; set; }
        public string data_Age { get; set; }
        public string data_Polarity { get; set; }
        public int data_Rerolls { get; set; }
        public string data_Stat1 { get; set; }
        public int data_Stat1val { get; set; }
        public string data_Stat2 { get; set; }
        public int data_Stat2val { get; set; }
        public string data_Stat3 { get; set; }
        public int data_Stat3val { get; set; }
        public string data_Stat4 { get; set; }
        public int data_Stat4val { get; set; }
        public string data_Seller { get; set; }
        public string data_Online { get; set; }
    }
    ...
    public class WFApi
    {
        ...
        public RmRiven[] RmRiven { get; set; }
    }
