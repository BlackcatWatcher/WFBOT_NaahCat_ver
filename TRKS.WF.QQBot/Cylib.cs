...
namespace TRKS.WF.QQBot
{
    ...
    public static class MessageExtensions
    {
        ...
        public static string AddPlatformInfowm(this string str)
        {
            return $"{str}\n这些东西是从Warframe.Market找来哒!";
        }
